...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_experimentKey":"GTM-MPZP6R8_OPT-WX6R9",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"vpz_wteEQqag_7Rmqk8rUw",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"GTM-MPZP6R8_OPT-WX6R9",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18380,"vpz_wteEQqag_7Rmqk8rUw",18455]
    },{
      "function":"__gthc",
      "vtp_trackingId":"UA-67589403-1"
    },{
      ...
      "vtp_experimentState":["macro",4],
      "vtp_sectionIndex":0,
      "vtp_serverVariationIndex":["macro",15]
    }],
  "tags":[{
      "function":"__asprv",
      ...
      "once_per_load":true,
      "vtp_trackingId":"UA-67589403-1",
      "vtp_hitParams":["map","title","","anonymizeIp","1","nonInteraction",true,"adSenseId",["macro",14],"language",["macro",14],"encoding",["macro",14],"screenColors",["macro",14],"screenResolution",["macro",14],"viewportSize",["macro",14],"flashVersion",["macro",14],"referrer",["macro",14],"location",["macro",14],"hitType","data"],
      "tag_id":28
    },{
      "function":"__noop",
      ...
      "function":"__em",
      "vtp_selector":"#dartpad-landing-page",
      "vtp_identifier":"#dartpad-landing-page",
      "vtp_targetSelector":"section.homepage__key-points",
      "vtp_targetIdentifier":"section.homepage__key-points",
      "vtp_mode":"AFTER",
      "tag_id":32
    },{
      "function":"__exsu",
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_GTM-MPZP6R8_OPT-WX6R9:0",
      "vtp_contextIndex":0,
      "tag_id":30
    }],
  "predicates":[{
...
return null},yc=!1;if(E.querySelectorAll)try{var zc=E.querySelectorAll(":root");zc&&1==zc.length&&zc[0]==E.documentElement&&(yc=!0)}catch(a){}var vc=yc;var Pc={},Qc=null,Rc=Math.random();Pc.w="GTM-MPZP6R8";Pc.Kb="4f0";var Sc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Tc="www.googleoptimize.com/gtm.js";var Uc=Tc,Vc=null,Wc=null,Xc=null,Yc="//www.googletagmanager.com/a?id="+Pc.w+"&cv=2",Zc={},$c={},ad=function(){var a=Qc.sequence||0;Qc.sequence=a+1;return a};var bd={},I=function(a,b){bd[a]=bd[a]||[];bd[a][b]=!0},cd=function(a){for(var b=[],c=bd[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
var qh={"":"n",UA:"u",AW:"a",DC:"d",G:"e",GF:"f",HA:"h",GTM:oh,OPT:"o"},rh=function(a){var b=Pc.w.split("-"),c=b[0].toUpperCase(),d=qh[c]||"i",e=a&&"GTM"===c?b[1]:"OPT"===c?b[1]:"",f;if(3===Pc.Kb.length){var h=void 0;h=h||"z";f="2"+(h||"w")}else f=
...
g(a[1])&&(b={},Qa(a[2])||ra(a[2])?b[a[1]]=C(a[2]):b[a[1]]=a[2]);if(b){b._clear=!0;return b}}};var ij={policy:!0};var jj=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},lj=function(a){var b=kj(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};var mj=!1,nj=[];function oj(){if(!mj){mj=!0;for(var a=0;a<nj.length;a++)H(nj[a])}}var pj=function(a){mj?H(a):nj.push(a)};
var zj=function(){},Aj=function(){var a=D.gaData,b=0,c=void 0;if(a)for(var d in a)if(a.hasOwnProperty(d)&&0===d.indexOf("UA-")&&a[d].hitcount){b+=a[d].hitcount;var e=Number(a[d].first_hit);e&&(!c||e<c)&&(c=e)}return{we:b,pe:c}},sj=function(a,b){var c,d,e,f,h,k,l,m,q;return{xb:d,yb:c,hc:e,ic:f,Vb:h,oc:k,rb:l,Rc:m,qb:q}},yj=function(a,b){b=void 0===b?"ol":b;},Cj=!1,qj,tj,uj,Bj,vj,wj,xj;var Dj=function(){},Fj=function(a){var b=Ej;};var Hj=function(a){if(Gj(a))return a;this.h=a};Hj.prototype.yg=function(){return this.h};var Gj=function(a){return!a||"object"!==Oa(a)||Qa(a)?!1:"getUntrustedUpdateValue"in a};Hj.prototype.getUntrustedUpdateValue=Hj.prototype.yg;var Ij=[],Jj=!1,Kj=function(a){return D["dataLayer"].push(a)},Lj=function(a){var b=Qc["dataLayer"],c=b?b.subscribers:1,d=0;return function(){++d===c&&a()}};
function Mj(a){var b=a._clear;za(a,function(f,h){"_clear"!==f&&(b&&Jd(f,void 0),Jd(f,h))});Vc||(Vc=a["gtm.start"]);Dj();var c=a.event;if(!c)return!1;var d=a["gtm.uniqueEventId"];d||(d=ad(),a["gtm.uniqueEventId"]=d,Jd("gtm.uniqueEventId",d));Xc=c;var e=Nj(a);Xc=null;switch(c){case "gtm.init":I("GTM",19),e&&I("GTM",20)}return e}
...
b);return D[a]},Jk=function(a,b,c){return Wf(a,b,void 0===c?!0:!!c)},Kk=function(a,b){if(Ud()){b&&H(b)}else lc(a,b)},Lk=function(a){return!!Zj(a,"init",!1)},Mk=function(a){Xj(a,"init",!0)},Nk=function(a,b){var c=(void 0===b?0:b)?"www.googleoptimize.com/gtag/js":Uc;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";T(Q("https://","http://",c))},Ok=function(a,b){var c=a[b];return c};
var Pk=Sj.Rg;
var Qk=function(a){if(!a||a.nodeType!=Node.ELEMENT_NODE)return!1;var b=a.tagName.toUpperCase();return"SCRIPT"==b||"STYLE"==b||"LINK"==b},Rk=function(a,b,c){null==c?a.removeAttribute(b):a.setAttribute(b,c)},Sk=function(a,b,c){var d=a.getAttribute(b);Rk(a,b,c);return function(){Rk(a,b,d)}},Vk=function(a,b,c){var d,e,f=a.ownerDocument||a.document||document;c=(c||"").toLowerCase();"after"==c?(d=a.parentNode,e=a.nextSibling):"insert"==c?(d=a,e=a.firstChild):"append"==c?(d=a,e=null):(d=a.parentNode,e=a);
if(!d||d==f)return{result:1,Fg:[]};var h=Tk(b,d);Uk(h,"SCRIPT");Uk(h,"NOSCRIPT");var k=[];if(h.firstChild)for(var l=h.firstChild;l;){var m=l.nextSibling;k.push(l);d.insertBefore(l,e);l=m}var q=a.nextSibling;"replace"==c&&d.removeChild(a);return{result:function(){for(;0<k.length;)d.removeChild(k.pop());"replace"==c&&d.insertBefore(a,q)},Fg:k.slice()}},Wk={SELECT:[1,'<select multiple="multiple">',"</select>"],FIELDSET:[1,"<fieldset>","</fieldset>"],MAP:[1,"<map>","</map>"],OBJECT:[1,"<object>","</object>"],
TABLE:[1,"<table>","</table>"],TBODY:[2,"<table><tbody>","</tbody></table>"],COLGROUP:[2,"<table><colgroup>","</colgroup></table>"],TR:[3,"<table><tbody><tr>","</tr></tbody></table>"]},Tk=function(a,b){var c=0,d="",e="",f=Wk[b.tagName];null!=f&&(c=f[0],d=f[1],e=f[2]);var h=document.createElement("div");h.innerHTML=d+(a||"")+e;for(var k=h;0<c;){var l=k.firstChild;if(!(l instanceof Element))return document.createElement("div");k=l;c--}return k},Uk=function(a,b){for(var c=a.getElementsByTagName(b),d=
[],e=c.length-1;0<=e;e--){var f=c[e];f.parentNode.removeChild(f);d.push(f)}},Xk=function(a){var b=null,c=null;try{b=new Function("element",a)}catch(d){c=d}return{Oc:b,error:c}},al=function(a,b,c,d,e){var f=a+"{"+(b+": "+c+(d?" !important":""))+"}";e&&(f=e+"{"+f+"}");var h=document;if(h.createStyleSheet){var k=Yk(h),l=k.rules.length;k.insertRule(f,l);return function(){k.deleteRule?k.deleteRule(l):k.removeRule(l);k.insertRule("x {}",l)}}var m=Zk(f,h);$k(m,h);var q=m.parentNode;return function(){q.removeChild(m)}},
bl=null,Yk=function(a){if(bl)return bl;for(var b=a.styleSheets.length-1;0<=b;b--){var c=a.styleSheets[b],d=c.ownerNode;if(d&&d.parentNode&&"HEAD"==d.parentNode.tagName)return bl=c}0==a.styleSheets.length&&a.createStyleSheet();return bl=a.styleSheets[0]},Zk=function(a,b){var c=(b||document).createElement("style");void 0!==c.cssText?c.cssText=a:c.innerHTML=a;return c},$k=function(a,b){var c=b||document,d=c.getElementsByTagName("head")[0];d||(d=c.createElement("head"),c.body.parentNode.insertBefore(d,
c.body));d.appendChild(a)},cl=function(a,b,c,d){if(a.style.setProperty)try{var e=a.style.getPropertyValue(b),f=a.style.getPropertyPriority(b);a.style.setProperty(b,c,d?"important":"");return function(){a.style.setProperty(b,"",f);a.style.setProperty(b,e,f)}}catch(k){}var h=a.style.cssText;a.style.cssText+=";"+(b+": "+c+(d?" !important":""))+";";return function(){a.style.cssText=h}},el=function(a,b,c,d){if(Qk(a))return 7;if(b)return dl(a,b,d);if(c&&c.parentNode){var e=a.parentNode,f=a.nextSibling;
c.parentNode.insertBefore(a,c.nextSibling);return function(){e.insertBefore(a,f)}}return 4},dl=function(a,b,c){var d=a.parentNode,e=a.nextSibling;c=(c||"").toLowerCase();if("bottom"==c)b.appendChild(a);else if("top"==c)b.insertBefore(a,b.childNodes[0]||null);else if("before"==c)if(b.parentNode)b.parentNode.insertBefore(a,b);else return 5;else if("after"==c)if(b.parentNode)b.parentNode.insertBefore(a,b.nextSibling);else return 5;return function(){d.insertBefore(a,e)}},fl=function(a,b,c){if(0<=b&&b<
a.childNodes.length){var d=a.childNodes[b];if(null!=d&&d.nodeType==Node.TEXT_NODE){var e=d.nodeValue;d.nodeValue=c;return function(){d.nodeValue=e}}return 2}return 3},gl=function(a,b,c,d){c?d=c.nextSibling:d&&(c=d.previousSibling);if(null!=c&&c.nodeType==Node.TEXT_NODE){var e=c.nodeValue;c.nodeValue+=a;return function(){c.nodeValue=e}}if(null!=d&&d.nodeType==Node.TEXT_NODE){var f=d.nodeValue;d.nodeValue=a+d.nodeValue;return function(){d.nodeValue=f}}var h=(b.ownerDocument||b.document||document).createTextNode(a);
d?b.insertBefore(h,d):b.appendChild(h);return function(){b.removeChild(h)}},hl=function(a){var b=document.createElement("a");a&&(b.href=a);return b};var ll=new xa;function ml(a,b){function c(h){var k=Ye(h),l=Xe(k,"protocol"),m=Xe(k,"host",!0),q=Xe(k,"port"),r=Xe(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==q||"https"==l&&"443"==q)l="web",q="default";return[l,m,q,r]}for(var d=c(String(a)),e=c(String(b)),f=0;f<d.length;f++)if(d[f]!==e[f])return!1;return!0}
...
var ul=function(a,b,c){for(var d={},e=!1,f=0;a&&f<a.length;f++)a[f]&&a[f].hasOwnProperty(b)&&a[f].hasOwnProperty(c)&&(d[a[f][b]]=a[f][c],e=!0);return e?d:null};ql.Ig=function(){var a=!1;return a};var xl=function(a){if(!vl[a]){vl[a]=!0;var b=D[a]||{};D[a]=b;var c=function(e){return wl[e]},d=b.get;b.get=d?function(e){return void 0!==wl[e]?wl[e]:d(e)}:c}},yl=function(a,b,c){try{a(c,b)}catch(d){}},Al=function(a){zl[a]=zl[a]||[];return zl[a]},wl={},zl={},vl={};
var Bl=function(a){D.gaData=D.gaData||{};var b=D.gaData,c=b.tracker_created;b.tracker_created=function(d){c&&pa(c)&&c(d);a(d)}},Cl=function(a){var b=D[Pe()];try{if(pa(b)&&pa(b.getAll))return sa(b.getAll(),function(c){return c.get("trackingId")===a})}catch(c){console.log("Optimize: GA Exception "+c+" trackingId: "+a+" exception: "+c)}},Il=function(a,b){var c=Dl[a];if(c)H(function(){return b(c)});else{var d=Cl(a);d?(Dl[a]=d,El||(El=d),H(function(){return b(d)})):(Fl[a]||(Fl[a]=[]),Fl[a].push(b),Gl||
(Gl=!0,Bl(function(e){var f=e.get("trackingId");if(Fl[f]){if(Hl[f]){Hl[f]=!1;var h=D[Pe()];pa(h)&&h("ga.require","_"+Pc.w)}El||(El=e);Dl[f]=e;for(var k=Fl[f],l;void 0!==(l=k.shift());)l(e);Fl[f]=void 0}})))}},Dl={},Fl={},Hl={},El,Gl=!1,Jl=function(a,b,c){Il(a,function(d){var e=D[Pe()];if("data"===b.hitType&&c){var f=D.gaData,h=Number(f&&f[a]&&f[a].first_hit),k=Fa();!isNaN(h)&&k>h&&(b.queueTime=Math.min(1E3,k+100-h))}try{var l="t0"!=d.get("name")?d.get("name")+".send":"send";e(l,b)}catch(m){console.log("Optimize: failed to send hit using tracker: "+
d.name+" exception "+m)}})};
var Nl=function(a,b,c){function d(){f||(f=!0,!0!==Kl&&(Kl=!1),Ll(c),jj(kj(),e))}Ej=a;var e="GTM-MPZP6R8_"+b,f=!1;lj(e);D.google_optimize=D.google_optimize||{};var h=D.google_optimize;h["GTM-MPZP6R8"]=h["GTM-MPZP6R8"]||{};h["GTM-MPZP6R8"].optimize_dyn=function(l){l.split(",").forEach(function(m){Ml[m]=!0});Kl=!0;d()};jc(a,void 0,d);var k=kj();D.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},Ll=function(a){if(void 0!==Ol){var b=Ol-Pl,c,d;Kl?c=Fa()-Ol:d=Fa()-Ol;Fj({th:b,Og:c,Mg:d})}Ml.optimize_ready=
!0;Kj({event:"opt.dyn"});Kj({event:"opt.js"});if(a&&0<a.length){var e={};kj().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&Kj({event:f})})}H(function(){Qe("_"+Pc.w)})},kj=function(){return D["dataLayer"]},Ql=function(a,b,c,d,e,f,h){function k(p,t){t&&(r+="&"+p+"="+encodeURIComponent(t))}Pl=Fa();if(a||b||c){var l=void 0;if(b){var m=ah().aw;m&&(l=m[0])}if(f&&(a||c||l)){var q=1,r,u="GTM-MPZP6R8_"+q++;lj(u);Hl[d]=!0;Il(d,function(p){Ol=Fa();a||b?(r="https://www.google-analytics.com/gtm/optimize-dyn.js?id=GTM-MPZP6R8",
a&&k("cid",p.get("clientId")),k("gclid",l),h&&(k("gtm_auth",""),k("gtm_preview","")),(h||a)&&k("cb",String(Math.random())),Nl(r,q++,e)):Ll(e);jj(kj(),u)})}else Ll(e)}},Ml={},Pl,Ol,Kl,Ej;var Rl=function(a,b){this.Sb=a;this.vb=b};Rl.prototype.toString=function(){var a=""+this.Sb;1<this.vb&&(a=a+"-"+this.vb);return a};var Sl=function(a,b){this.i=a;this.h=b};Sl.prototype.toString=function(){return this.h+"."+this.i};
var Tl=function(){var a=Fd("optimize.cookie_path",2);return g(a)?a:"/"},Vl=function(a,b){var c=new Ul(a,b);c.Wg();return c},Ul=function(a,b){this.O=Math.floor(new Date/864E5);this.i=a||"auto";this.h=b||Tl();this.m=new Rl(ig(this.i),jg(this.h));this.s=[];this.map={}};ba=Ul.prototype;ba.xg=function(a){if(!a)return"";var b=this.Pc(a);return b?b.i:""};ba.lh=function(a,b,c,d,e){var f,h;f=void 0===f?10:f;h=void 0===h?3E3:h;if(!a)return!1;void 0==b&&(b="");this.mc(a,new Sl(b,c));this.Pf(e);return this.Sg(d,
f,h)};ba.Pc=function(a){return this.map[a]};ba.wg=function(){for(var a=0,b=0;b<this.s.length;b++)"x"!==this.Pc(this.s[b]).i[0]&&a++;return a};ba.mc=function(a,b){a&&(""===b.i?this.Oe(a):(this.map[a]||this.s.push(a),this.map[a]=b))};ba.oh=function(a){for(var b=0;b<a.length;b++)this.mc(a[b][0],a[b][1])};ba.Oe=function(a){var b=n(this.s,a);0<=b&&this.s.splice(b,1);delete this.map[a]};ba.eh=function(){for(var a=[],b=0;b<this.s.length;b++){var c=this.s[b];this.map[c].h<this.O&&a.push(c)}for(var d=0;d<
a.length;d++)this.Oe(a[d])};ba.vg=function(){for(var a=[],b=0;b<this.s.length;b++){var c=this.s[b];a.push([c,this.map[c]])}return a};ba.mg=function(){for(var a=0,b=0;b<this.s.length;b++)a=Math.max(a,this.map[this.s[b]].h);return 864E5*a};ba.toString=function(){if(0==this.s.length)return"";for(var a=[],b=0;b<this.s.length;b++){var c=this.s[b];a.push(c+"."+this.map[c].toString())}return"GAX1."+this.m.toString()+"."+a.join("!")};ba.Sg=function(a,b,c){var d=new Date;this.eh();var e=this.wg();if(e>b||
e>(a||10)&&document.cookie.replace(/(?:;\s*)?(_gaexp=[^;]+)(?:;\s*)?/,this.toString()).length>c)return!1;d.setTime(this.mg());if("auto"!=this.i)return this.m=new Rl(ig(this.i),jg(this.h)),eg("_gaexp",this.toString(),{path:this.h,domain:this.i,expires:d});for(var f=bg(),h=0;h<f.length;h++)if(this.m=new Rl(ig(f[h]),jg(this.h)),eg("_gaexp",this.toString(),{path:this.h,domain:f[h],expires:d}))return!0;return!1};ba.Wg=function(){var a=Zf("_gaexp",this.m.Sb,this.m.vb);if(a){var b=this.Xg(a);b&&this.oh(b.vg())}};
ba.Xg=function(a){for(var b=new Ul(this.i,this.h),c=a.split("!"),d=0;d<c.length;d++){var e=c[d].split(".");if(3==e.length){if(isNaN(Number(e[1])))return;b.mc(e[0],new Sl(e[2],Number(e[1])))}}return b};ba.Pf=function(a){a=a||{};var b=0;a.hasOwnProperty("")&&!isNaN(Number(a[""]))&&(b=this.O-Aa(a[""]));for(var c=0;c<this.s.length;c++){var d=this.s[c];if(a.hasOwnProperty(d)&&!isNaN(Number(a[d]))){var e=this.Pc(d);e.h=Aa(a[d])+b;this.mc(d,e)}}};
var Wl=function(a){if(se)return!0;for(;a;){if(a.nextSibling)return!0;a=a.parentNode}return!1},Xl=function(a,b){for(var c=wc(a.I)||[],d=[],e=0;e<c.length;e++){var f=c[e];if(!f.gtmProgressiveApplied||!f.gtmProgressiveApplied[b]){if(a.T&&!Wl(f))break;d.push(f)}}return d},Yl=function(a,b){return function(){a.gtmProgressiveApplied&&delete a.gtmProgressiveApplied[b]}},Zl=function(a,b){a.gtmProgressiveApplied||(a.gtmProgressiveApplied={});a.gtmProgressiveApplied[b]=!0},$l=function(a,b){var c=[];if(b.da){var d=
Xl(b.da,b.id),e=null;b.nc&&(e=Xl(b.nc,b.id+"-t"));for(var f=0;f<d.length;f++){var h=d[f],k=void 0;if(null!=e&&(k=e.length>f?e[f]:null,!k&&!se&&(null===b.nc.F||b.ee+c.length<b.nc.F)))break;c.push({element:h,rh:k})}}if(!se&&b.Jf&&(!a||null==b.da.F||b.da.F!=b.Kc+c.length))return!1;for(var l=0;l<c.length;l++){var m=c[l].element,q=c[l].rh,r=void 0;b.Kc++;Zl(m,b.id);q&&(b.ee++,r=b.id+"-t",Zl(q,r));var u=b.Qf(m,q);pa(u)&&b.Ta.push(u);b.Ta.push(Yl(m,b.id));q&&r&&b.Ta.push(Yl(q,r))}if(b.da.F&&b.da.F==b.Kc||
se)b.finished=!0;return!0},am=function(a){for(var b={},c=0;c<a.U.length;c++){var d=a.U[c];if(d.da){var e=b[d.da.I];e||(e=b[d.da.I]=wc(d.da.I)||[]);for(var f=0;f<e.length;f++){var h=e[f];h.gtmProgressiveApplied&&h.gtmProgressiveApplied[d.id]||(Zl(h,d.id),d.Ta.push(Yl(h,d.id)))}}}},bm=function(a){if(!a.jd){for(var b=a.pb;b<a.U.length;b++){var c=a.U[b],d=b==a.pb;if(!c.finished&&!$l(d,c))break;c.finished&&d&&a.pb++}a.U.length>a.pb?(a.qa||(a.qa=D.setTimeout(function(){a.qa=null;bm(a)},80)),se||a.ad||(a.ad=
function(){H(function(){bm(a)})},nc(E,"DOMContentLoaded",a.ad))):am(a)}},cm={},dm={},em=void 0,fm=function(a,b,c,d){var e=em;if(!vc||!e)return!1;var f={id:e.id+":"+e.U.length,Qf:b,Ta:[],Jf:c,da:a,Kc:0,nc:d||null,ee:0,finished:!1};e.U.push(f);null===a?(f.finished=!0,b(null)):bm(e);return!0},gm=function(a){var b=al(a,"visibility","hidden",!0);return function(){pa(b)&&b.apply();b=null}},hm=function(a,b,c,d){var e=b;if(!se){var f=gm(a.I);ue.push(f);e=function(h,k){var l=b(h,k);f();return l}}return fm(a,
...
function cn(a,b){}var Z={a:{}};Z.a.dee=["google"],function(){(function(a){Z.__dee=a;Z.__dee.b="dee";Z.__dee.g=!0;Z.__dee.priorityOverride=0})(function(){var a=!1;return a?"gtm.sync":"gtm.js"})}();

Z.a.exs=["google"],function(){(function(a){Z.__exs=a;Z.__exs.b="exs";Z.__exs.g=!0;Z.__exs.priorityOverride=0})(function(a){var b=Vl(a.vtp_cookieDomain,a.vtp_cookiePath).xg(a.vtp_measurementId);if(""===b)return b;if("x"===b[0]){var c=Number(b.substring(1));if("x"===b||isNaN(c)||0>c||1E3<=c)return""}else{var d=a.vtp_sections;if(d){var e=b.split("-");if(d.length!=e.length)return"";for(var f=0;f<d.length;f++)if(0>e[f]||e[f]>=d[f])return""}}return b})}();
Z.a.optua=["google"],function(){(function(a){Z.__optua=a;Z.__optua.b="optua";Z.__optua.g=!0;Z.__optua.priorityOverride=0})(function(a){Jl(a.vtp_trackingId,a.vtp_hitParams,a.vtp_correctDataHit);a.vtp_gtmOnSuccess()})}();

Z.a.sel=["google"],function(){(function(a){Z.__sel=a;Z.__sel.b="sel";Z.__sel.g=!0;Z.__sel.priorityOverride=0})(function(a){return wc(a.vtp_selector)})}();Z.a.c=["google"],function(){(function(a){Z.__c=a;Z.__c.b="c";Z.__c.g=!0;Z.__c.priorityOverride=0})(function(a){return a.vtp_value})}();
...
Z.a.exsu=["google"],function(){(function(a){Z.__exsu=a;Z.__exsu.b="exsu";Z.__exsu.g=!0;Z.__exsu.priorityOverride=0})(function(a){Vl(a.vtp_cookieDomain,a.vtp_cookiePath).lh(a.vtp_measurementId,a.vtp_newState,a.vtp_expirationDay,a.vtp_max,a.vtp_expirationDates)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()})}();
Z.a.ctto=["google"],function(){(function(a){Z.__ctto=a;Z.__ctto.b="ctto";Z.__ctto.g=!0;Z.__ctto.priorityOverride=0})(function(a){var b=a.vtp_isDynamic,c=V("dataLayer"),d=c&&c.hide;if(!d)return!1;var e=Pc.w,f=V("document");if(void 0===f.querySelector)return!1;var h=!!f.querySelector("body");if(null!==d.end||!h)return!1;if(!b)return!0===d[e];for(var k in d)if(d.hasOwnProperty(k)&&k.startsWith(e)&&!0===d[k])return!0;return!1})}();
Z.a.dr=["google"],function(){(function(a){Z.__dr=a;Z.__dr.b="dr";Z.__dr.g=!0;Z.__dr.priorityOverride=0})(function(a){var b=a.vtp_treatmentId,c=a.vtp_activate,d=a.vtp_contentSignature,e=a.vtp_isEmpty,f=U("optimize.experimentCallback",1),h=a.vtp_measurementId,k=a.vtp_experimentCombination,l;if(l=c){var m=cm[h];l=!(!m||m==b)}if(l)a.vtp_gtmOnFailure();else{var q=U("optimize.whitelist",1);if(q&&q[h]?q[h]===d:me()?e:1){if(pa(f)){var r={xid:h,xvar:k,activate:c};try{f(r)}catch(R){}}var u=!1,p=!0;if(c){var t;
cm[h]=b;var v=dm[b];if(v){for(var w=v.pb=0;w<v.U.length;w++)v.U[w].finished=!1;bm(v);t=!0}else t=!1;if(t)u=!0;else{var x=dm[b];x||(x={id:b,U:[],pb:0,qa:null,ad:void 0,jd:!1},dm[b]=x);em=x}}else{var y=dm[b];if(!y||y.jd)p=!1;else{for(;y.U.length;)for(var B=y.U.pop();B.Ta.length;){var z=B.Ta.pop();if(pa(z))try{z()}catch(R){}}y.jd=!0;delete dm[b];p=!0}}if(p){var A=c?k:void 0;wl[h]=A;for(var F=Al(h),G=0;G<F.length;G++)yl(F[G],h,A);F=Al("");for(var L=0;L<F.length;L++)yl(F[L],h,A)}a[u?"vtp_gtmOnFailure":
"vtp_gtmOnSuccess"]()}else a.vtp_gtmOnFailure()}})}();
Z.a.gthc=["google"],function(){(function(a){Z.__gthc=a;Z.__gthc.b="gthc";Z.__gthc.g=!0;Z.__gthc.priorityOverride=0})(function(a){var b=V("gaData",{}),c=!1;if(c)return-1;var d=a.vtp_trackingId;return b[d]&&b[d].hitcount?b[d].hitcount:0})}();
Z.a.uv=["google"],function(){(function(a){Z.__uv=a;Z.__uv.b="uv";Z.__uv.g=!0;Z.__uv.priorityOverride=0})(function(){})}();
Z.a.em=["google"],function(){(function(a){Z.__em=a;Z.__em.b="em";Z.__em.g=!0;Z.__em.priorityOverride=0})(function(a){var b=a.vtp_selector,c=a.vtp_targetSelector,d=a.vtp_mode,e=a.vtp_identifier,f=a.vtp_targetIdentifier,h=a.vtp_affectsSelectors;!1!==h&&(h=!0);var k;em?vc?hm({I:b,T:!0,F:b==e?1:null},function(l,m){var q;if(l){if(q=el(l,m,k,d),m||k)k=l}else q=function(){};return q},h,{I:c,T:!0,F:c==f?1:null})?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure():a.vtp_gtmOnFailure():a.vtp_gtmOnFailure()})}();



Z.a.cevi=["google"],function(){(function(a){Z.__cevi=a;Z.__cevi.b="cevi";Z.__cevi.g=!0;Z.__cevi.priorityOverride=0})(function(a){var b=a.vtp_experimentState,c=a.vtp_serverVariationIndex;return""===b||"x"===b[0]?c:Number(b.split("-")[a.vtp_sectionIndex])})}();
Z.a.cie=["google"],function(){(function(a){Z.__cie=a;Z.__cie.b="cie";Z.__cie.g=!0;Z.__cie.priorityOverride=0})(function(a){var b=a.vtp_experimentState,c=a.vtp_trafficCoverageHash;return""!==b&&"x"!==b[0]?!0:a.vtp_trafficCoverage>(""==b?c:Number(b.substring(1)))})}();

Z.a.asprv=["google"],function(){(function(a){Z.__asprv=a;Z.__asprv.b="asprv";Z.__asprv.g=!0;Z.__asprv.priorityOverride=0})(function(a){var b=a.vtp_globalName,c=U("eventModel");b&&xl(b);var d,e,f;c&&(d=c.name||"",e=c.callback,f=c.remove);if(e&&pa(e))if(d=String(d),!0!==f){var h=d,k=e;Al(h).push(k);if(""!==h)void 0!==wl[h]&&yl(k,h,wl[h]);else for(var l in wl)void 0!==wl[l]&&yl(k,l,wl[l])}else{var m=e,q=Al(d),r=q.indexOf(m);0<=r&&q.splice(r,1)}a.vtp_gtmOnSuccess()})}();
Z.a.gaoo_c=["google"],function(){(function(a){Z.__gaoo_c=a;Z.__gaoo_c.b="gaoo_c";Z.__gaoo_c.g=!0;Z.__gaoo_c.priorityOverride=0})(function(a){var b=V("_gaUserPrefs");try{if(b&&b.ioo&&b.ioo())return!0}catch(d){}if(E.getElementById("__gaOptOutExtension"))return!0;var c=V("external");return c&&"oo"==c._gaUserPrefs?!0:!!V("ga-disable-"+a.vtp_trackingId)})}();
...
Z.a.uae=["google"],function(){(function(a){Z.__uae=a;Z.__uae.b="uae";Z.__uae.g=!0;Z.__uae.priorityOverride=0})(function(a){var b=V("gaData",{},!1),c=a.vtp_trackingId,d=a.vtp_measurementId,e=a.vtp_experimentCombination;if(c){b[c]=b[c]||{};var f=b[c];f.pending_experiments=f.pending_experiments||{};f.pending_experiments[d]=e;f.experiments=f.experiments||{};f.experiments[d]=e}var h=!1;if(!c||h)b.expId=d,b.expVar=e;a.vtp_gtmOnSuccess()})}();
...
!0;try{p=!D.frameElement}catch(x){}p&&we()}nc(D,"load",ve)}mj=!1;"complete"===E.readyState?oj():nc(D,"load",oj);a:{if(!vd)break a;D.setInterval(wd,864E5);}Kj({event:"gtm.js"});Wc=(new Date).getTime();}}
gn();
